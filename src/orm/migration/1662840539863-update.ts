...
export class update1662840539863 implements MigrationInterface {
    name = 'update1662840539863'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`person\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`IdCard\` varchar(255) NOT NULL, \`personType\` int NOT NULL, \`birthday\` datetime NOT NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
